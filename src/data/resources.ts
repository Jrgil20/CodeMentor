...
export const resources: Resource[] = [
  {
    ...
    description: "Diseño e implementación integral de un sistema de bases de datos relacional robusto en la UCAB. Calificación final obtenida: 20 / 20. Incluye modelado E/R, normalización BCNF, consultas SQL complejas y lógica transaccional ACID.",
  ...
  },
  {
    ...
    description: "Herramienta web interactiva para la planificación y consolidación de horarios universitarios en Ingeniería Informática (UCAB). Organiza secciones con drag & drop, detecta conflictos automáticamente, calcula horas semanales y permite copiar los NRCs al portapapeles.",
  ...
  {
    id: 4,
    title: "Visualizador Interactivo de Estructuras de Datos y Algoritmos (USFCA)",
    description: "Animaciones y simulaciones interactivas paso a paso para comprender estructuras de datos complejas (árboles BST, AVL, grafos, algoritmos de ordenamiento) en tiempo real.",
